...
export default function PremiumBanner() {
  return (
    <div className="w-full md:max-w-[400px] rounded-3xl bg-linear-to-br from-brand-dark to-brand-dark-alt p-5 md:p-6 text-white shadow-xl relative overflow-hidden shrink-0 border border-white/10 group mb-8 md:mb-0 flex flex-col justify-between h-auto md:h-[220px]">
      ...
      >
        <span className="font-bold text-body-md text-transparent bg-clip-text bg-linear-to-r from-brand-cyan to-brand-purple tracking-wide">
      ...
      <div className="absolute top-0 right-0 w-[200px] h-[200px] bg-linear-to-br from-brand-cyan/20 via-brand-purple/20 to-transparent rounded-full blur-[50px] -mr-16 -mt-16 pointer-events-none" />
    </div>
  );
}
