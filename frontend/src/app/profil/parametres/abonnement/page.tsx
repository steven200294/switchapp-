            ...
            <div className="w-full bg-brand-dark p-6 lg:p-8 rounded-3xl relative overflow-hidden group border border-white/10 shadow-2xl text-left">
              <div className="relative z-10">
                ...
                <h4 className="text-title-md md:text-display-xs font-bold text-white leading-tight mb-4 tracking-tight">
                  Passez à<br/><span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-cyan to-brand-purple">SwitchPremium</span>
                </h4>
                
                <ul className="space-y-4 mb-8">
                  <li className="flex items-center text-gray-300 text-body-md font-medium">
                     <span className="flex-shrink-0 w-6 h-6 rounded-full bg-white/10 flex items-center justify-center mr-4"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" className="w-3.5 h-3.5 text-brand-cyan"><path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7"/></svg></span> 
              ...
              <button className="relative z-10 bg-white w-full text-black px-4 py-4 rounded-[14px] font-black text-body-md transition-all hover:scale-[1.02] active:scale-[0.98] shadow-xl shadow-brand-purple/25">
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-cyan to-brand-purple">S'abonner à partir de 9,99€ / mois</span>
              </button>
              
              {/* Lueur d'ambiance Premium */}
              <div className="absolute top-0 right-0 w-[300px] h-[300px] bg-gradient-to-br from-brand-cyan/20 via-brand-purple/20 to-transparent rounded-full blur-[60px] -mr-20 -mt-20 pointer-events-none"></div>
            </div>
