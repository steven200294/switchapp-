...
import CompatibilityGauge from "@/app/[locale]/explorer/components/CompatibilityGauge";
import type { CompatibilityResult } from "@/app/[locale]/explorer/types/compatibility.types";
...
export default function PropertyCompatibilityCard({ isLoading, error, data }: PropertyCompatibilityCardProps) {
  ...
  return (
    <section className="mb-8 p-5 rounded-2xl bg-linear-to-br from-brand-cyan/5 to-brand-purple/5 border border-brand-purple/15">
      <h3 className="text-title font-bold text-gray-900 mb-4">{t("yourCompatibility")}</h3>
