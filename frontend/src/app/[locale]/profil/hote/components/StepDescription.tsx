...
export default function StepDescription({ draft, update, onNext }: Props) {
  ...
  return (
    <div className="max-w-xl mx-auto px-6 py-10">
      <h2 className="text-display-sm font-black text-gray-900 mb-2">{t("descriptionTitle")}</h2>
      <p className="text-body-md text-gray-400 mb-8">{t("descriptionSubtitle")}</p>

      <div className="space-y-5 mb-10">
        <div>
          <label className="text-body-sm font-bold text-gray-500 uppercase tracking-widest mb-2 block">{t("titleLabel")}</label>
          <input
            type="text"
            value={draft.title}
        ...
        <div>
          <label className="text-body-sm font-bold text-gray-500 uppercase tracking-widest mb-2 block">{t("descLabel")}</label>
          <textarea
