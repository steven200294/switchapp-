      ...
      <div className="absolute inset-x-0 bottom-0 md:inset-0 md:left-auto md:w-full md:max-w-2xl h-full bg-white shadow-2xl flex flex-col md:animate-page-slide-right animate-page-slide-up overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto w-full px-6 lg:px-10 py-8 space-y-8">
          ...
          <div className="space-y-5">
            <div>
              <label className="text-body-sm font-bold text-gray-500 uppercase tracking-widest mb-2 block">{t("firstName")}</label>
              <input
                type="text"
            ...
            <div>
              <label className="text-body-sm font-bold text-gray-500 uppercase tracking-widest mb-2 block">{t("phone")}</label>
            ...
            <div>
              <label className="text-body-sm font-bold text-gray-500 uppercase tracking-widest mb-2 block">{t("cityLabel")}</label>
              <input
                type="text"
                value={form.city}
              ...
              />
              <p className="text-body-sm text-gray-400 mt-2">{t("informationCityHint")}</p>
            </div>
          </div>
        </main>
        ...
        <div className="shrink-0 px-6 lg:px-10 py-5 border-t border-gray-100">
          ...
          >
            {saved ? tCommon("saved") : tCommon("saveChanges")}
          </button>
        </div>
      </div>
    </div>
