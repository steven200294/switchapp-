      ...
      <div className="bg-white border border-gray-200 rounded-full shadow-md flex items-center h-16 relative">
        ...
        <div className="flex-1 h-full rounded-full hover:bg-gray-100 flex flex-col justify-center pl-8 pr-2 cursor-pointer transition-colors focus-within:bg-white focus-within:shadow-lg">
          <div className="flex items-center justify-between w-full h-full">
            ...
            <button
              type="button"
              className="w-12 h-12 rounded-full bg-gradient-to-r from-brand-cyan to-brand-purple hover:opacity-90 flex items-center justify-center text-background transition-opacity shrink-0 shadow-md"
