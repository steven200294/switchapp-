...
const SwipeIcon = ({ isActive }: { isActive: boolean }) => (
  <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill={isActive ? 'url(#nav-gradient)' : 'none'} stroke={isActive ? 'url(#nav-gradient)' : 'currentColor'} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ display: 'block', overflow: 'visible' }}>
...
export default function BottomNav() {
  ...
  return (
    <>
      {/* SVG Gradient Definition modifiée pour forcer le rendu sur Safari iOS */}
