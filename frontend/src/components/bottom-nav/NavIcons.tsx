export function ExplorerIcon({ isActive }: { isActive: boolean }) {
  return (
    <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" stroke={isActive ? "#111" : "currentColor"} strokeWidth={isActive ? "3" : "2"} style={{ display: "block", overflow: "visible" }}>
      <g fill="none">
...
export function FavorisIcon({ isActive }: { isActive: boolean }) {
  return (
    <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden role="presentation" focusable="false" width="24" height="24" fill={isActive ? "#111" : "none"} stroke={isActive ? "#111" : "currentColor"} strokeWidth="2" style={{ display: "block", overflow: "visible" }}>
