      ...
      <div className="absolute inset-x-0 bottom-0 md:inset-0 md:left-auto md:w-full md:max-w-2xl h-full bg-white shadow-2xl flex flex-col md:animate-page-slide-right animate-page-slide-up overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto w-full px-6 lg:px-10 pb-12">
          ...
          <div className="flex flex-col items-center justify-center py-10">
            ...
            <h2 className="text-[22px] font-bold text-gray-900 mb-2">Switch Gratuit</h2>
            <p className="text-[15px] font-medium text-gray-500 mb-10 text-center max-w-sm">
              Vous êtes actuellement sur l'offre gratuite. Swiper et discuter est toujours 100% gratuit !
            </p>

            <div className="w-full bg-[#111111] p-6 lg:p-8 rounded-3xl relative overflow-hidden group border border-white/10 shadow-2xl text-left">
              <div className="relative z-10">
                ...
                <h4 className="text-[22px] md:text-[26px] font-bold text-white leading-tight mb-4 tracking-tight">
                  Passez à<br/><span className="text-transparent bg-clip-text bg-gradient-to-r from-[#00BFFF] to-[#8A2BE2]">SwitchPremium</span>
                </h4>
                
                <ul className="space-y-4 mb-8">
                  <li className="flex items-center text-gray-300 text-[15px] font-medium">
                     <span className="flex-shrink-0 w-6 h-6 rounded-full bg-white/10 flex items-center justify-center mr-4"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" className="w-3.5 h-3.5 text-[#00BFFF]"><path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7"/></svg></span> 
              ...
              <button className="relative z-10 bg-white w-full text-black px-4 py-4 rounded-[14px] font-black text-[15px] transition-all hover:scale-[1.02] active:scale-[0.98] shadow-[0_0_20px_rgba(138,43,226,0.25)]">
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#0055FF] to-[#8A2BE2]">S'abonner à partir de 9,99€ / mois</span>
              </button>
              
              {/* Lueur d'ambiance Premium */}
              <div className="absolute top-0 right-0 w-[300px] h-[300px] bg-gradient-to-br from-[#00BFFF]/20 via-[#8A2BE2]/20 to-transparent rounded-full blur-[60px] -mr-20 -mt-20 pointer-events-none"></div>
            </div>
